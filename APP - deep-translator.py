...
# ── CLI 參數（從 local-ig.html 等外部工具調用時可預填） ──────────────────────
_ap = argparse.ArgumentParser(add_help=False)
_ap.add_argument('--folder', default='', help='預填文件夾路徑')
_ap.add_argument('--lang', default='en', help='預選目標語言 (en/zh-TW/zh-CN/ja/ko/th/fr/de)')
...
folder_var = tk.StringVar(value=_cli.folder)
lang_var = tk.StringVar(value=_cli.lang if _cli.lang else "en")
